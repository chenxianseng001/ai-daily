...
**An open-source AI intelligence aggregation platform.**
**Collect → Cluster → Summarize → Report.**
...
![AI Daily Report Preview](docs/images/preview.png)
...
A: 详见 [`MCP_CONFIG.md`](MCP_CONFIG.md)。
